...
<div align="center">
  ...
  <h3 align="center">VIUFLIX REBUILD</h3>

  <p align="center">
    This is my movie library project
    <br />
...
1. Get a free API Key at [https://example.com](https://developers.themoviedb.org/3)
2. Clone the repo
   ```sh
   git clone https://github.com/santosdave/viuflix.git
   ```
3. Install NPM packages
   ```sh
   npm install
   ```
4. Enter your TMDb API in `.env.local`
   ```js
   const REACT_APP_MOVIE_PUBLIC_API_KEY = 'ENTER YOUR API';
   ```
